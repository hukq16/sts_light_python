...
class sts: #this class replaces the original namespace 'sts'
    ...
    @staticmethod
    def getRelicName(id):
        return sts.relicNames[int(id)]

    @staticmethod
    def getRelicTier(id):
        return sts.relicTiers[int(id)]

    @staticmethod
    def getRelicBasePrice(id):
        return sts.RELICTIERPRICES[int(sts.getRelicTier(id))]

    @staticmethod
    def isEggRelic(id):
        return id == sts.RelicId.MOLTEN_EGG or id == sts.RelicId.FROZEN_EGG or id == sts.RelicId.TOXIC_EGG
